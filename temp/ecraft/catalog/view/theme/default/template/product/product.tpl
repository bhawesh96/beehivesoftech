...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="right">
      ...
      <div class="pincode">
  <span><strong>Enter pincode to check serviceability: </strong></span> &nbsp;
  <input type="text" name="zip_code" value="<?php echo $postcode; ?>" id="zip_code" size="8"/>
    <a id="button-zipcode" class="button" title="Check"><span>Check</span></a><br />
  <div id="temp_zipcode" style="width:94%;"></div>
  <br />
   <div id="tempzipcode" style="width:94%;"></div>
			...
			success: function (data)
			 {
				...
				$('#temp_zipcode').html('<div class="success" style="display: none;">Delivery available to  ' + dataObj.results[0].divisionname + '<img src="catalog/view/theme/default/image/close.png" alt="" class="close" id="closedDiv" /></div>');					
...
<?php echo $footer; ?>
<a href="javascript:void(0)" title="By,Dhanraj Kawale dk6504@gmail.com Copperbridge Media,Nagpur">?</a>