...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$this->data['button_zipcode'] = $this->language->get('button_zipcode');
			$this->data['text_zipcode'] = $this->language->get('text_zipcode');
...
// Get Customer Pincode DK
 if($this->customer->isLogged()){
		   $sql = 'SELECT postcode FROM '.DB_PREFIX.'address WHERE customer_id = '.$this->customer->getId();
		$query = $this->db->query($sql);
		//print_r($query->row['postcode']);
		
		$this->data['postcode'] = $query->row['postcode'];
 } else {
	 	$this->data['postcode'] =440033;
	 }
